...
class MySpider(CrawlSpider):
    ...
    def parse_link(self, response):
        ...
        for titles in titles:
            ...
            item["review_username1"] = encode_str(standardize_string(''.join(titles.xpath('//*[@data-expand-to="user-1"]/div/span[1]/text()').extract())))
            item["review_username2"] = encode_str(standardize_string(''.join(titles.xpath('//*[@data-expand-to="user-2"]/div/span[1]/text()').extract())))
            item["review_username3"] = encode_str(standardize_string(''.join(titles.xpath('//*[@data-expand-to="user-3"]/div/span[1]/text()').extract())))
            item["review_username4"] = encode_str(standardize_string(''.join(titles.xpath('//*[@data-expand-to="user-4"]/div/span[1]/text()').extract())))
            item["review_star1"] = encode_str(standardize_string(''.join(titles.xpath('//*[@data-expand-to="user-1"]/div/div[1]/div/@aria-label').extract())))
            item["review_star2"] = encode_str(standardize_string(''.join(titles.xpath('//*[@data-expand-to="user-2"]/div/div[1]/div/@aria-label').extract())))
            item["review_star3"] = encode_str(standardize_string(''.join(titles.xpath('//*[@data-expand-to="user-3"]/div/div[1]/div/@aria-label').extract())))
            item["review_star4"] = encode_str(standardize_string(''.join(titles.xpath('//*[@data-expand-to="user-4"]/div/div[1]/div/@aria-label').extract())))
            ...
            # item["test"] = ''.join(titles.xpath('//*[@data-expand-to="user-2"]/div/div[2]/div/text()').extract())
